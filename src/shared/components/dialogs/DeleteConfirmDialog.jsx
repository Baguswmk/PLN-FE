          ...
          <div className="space-y-4">
            ...
            {currentStep === 1 && (
              <div className="space-y-3">
                <div className="bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800 rounded-md  p-3">
                            ...
                            {showFleetDetails && (
                              <div className="mt-2 space-y-2">
                                {fleetsToProcess.map((fleet, idx) => (
                                  <div
                                    key={fleet.id}
                                    className="bg-white dark:bg-slate-900/50 rounded p-3  border-gray-200 dark:border-slate-700"
                                  >
                ...
                {assignedCount > 0 && (
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 border-yellow-200 dark:border-yellow-800 rounded-md  p-3">
                    <div className="flex gap-2">
            ...
            {currentStep === 1 && (
              <div className="space-y-4">
                ...
                {confirmAction === "no" && (
                  <div className="bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800 rounded-md  p-3">
            ...
            {currentStep === 2 && (
              <div className="space-y-4">
                ...
                {selectedDay === getCurrentDay() && (
                  <div className="bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800 rounded-md  p-3">
            ...
            <div className="flex flex-col sm:flex-row gap-2 pt-2">
              {currentStep > 1 && (
                <Button
                  className="w-full sm:w-auto px-4 py-2 rounded-md font-medium  border-gray-300 dark:border-slate-600 bg-transparent hover:bg-gray-100 dark:hover:bg-slate-800 text-gray-900 dark:text-white cursor-pointer transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1"
                  onClick={handleBack}
                  disabled={isProcessing}
                >
